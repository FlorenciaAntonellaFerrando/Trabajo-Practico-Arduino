...
⦁	Control Lógico por Máquina de Estados: se incorporó correctamente el estado de botones, potenciómetros (para la dificultad de los juegos) y el switch/interruptor (para cambiar de un juego a otro). 
